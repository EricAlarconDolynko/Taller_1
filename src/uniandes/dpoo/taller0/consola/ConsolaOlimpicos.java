...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta, y luego le muestra el país
	 * al que pertenece dicho atleta. 
	 */
	
	private void ejecutarPaisDeAtleta() {
		
		String nombre = input("Ingrese el atleta de su interés");
		String elPais = calculadora.PaisDeAtleta(nombre);
		...
		{
			System.out.println("El país al que pertenece "+ nombre +" es " + elPais);
		}
	}
